                ...
                >
                    ...
                    {courses.map((product) => (
                        <div
                            ...
                            className="flex flex-col flex-shrink-0 w-78 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group border border-gray-100 hover:border-gray-200"
                        >
                            {/* Product Image */}
