...
"[project]/.next-internal/server/app/api/checkWishList/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/checkWishList/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const existingWishList = await redis.get("wishList");
    if (existingWishList) {
        const found = existingWishList.find((wl)=>wl.id === parseInt(id));
        if (found) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be5afd63._.js.map